...
console.log(crearGato("firulay", 21));
...
function verificarPassword(objetoUsuario, password) {
  ...
  return objetoUsuario["password"] === password; //Debe tener entre comillas la propiedad.
}
...
console.log(agregarMetodoCalculoDescuento([12, 10]));
